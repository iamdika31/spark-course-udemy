...
//		System.setProperty("hadoop.home.dir", "c:/hadoop");
		...
		//STEP 3 - don't need chaptersID , setting up for a reduce
		...
		JavaPairRDD<Integer, Long> step8 = step7.mapValues(values -> {
			if(values > 0.9) return 10L;
			if(values > 0.5) return 4L;
			if(values > 0.25) return 2L;
			return 0L;
		});
